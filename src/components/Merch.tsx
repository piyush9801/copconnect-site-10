    ...
    >
      ...
      <div className="p-5">
        ...
        <div className="flex items-center justify-between">
          ...
          <span className="bg-ink/5 text-ink/60 text-[11px] font-bold uppercase tracking-wider px-3 py-2 rounded-full">
            Coming Soon
          </span>
        </div>
      </div>
  ...
  return (
    <section id="merch" className="bg-white px-4 sm:px-6 lg:px-8 py-24 md:py-32">
      <div className="max-w-[1320px] mx-auto">
        ...
        >
          <div className="inline-flex items-center gap-2 bg-brand text-white text-[11px] font-bold uppercase tracking-[0.18em] rounded-full px-3.5 py-1.5 mb-5">
            <span className="w-1.5 h-1.5 rounded-full bg-white animate-pulse" />
            Coming Soon · Merch Store
          </div>
          ...
          <p className="text-ink-mid text-base sm:text-lg leading-relaxed mt-5">
            The merch store is on its way — drop your email to be the first to know when it goes live. Every purchase will fund a free cyber awareness session for an underserved community.
          </p>
        </motion.div>
